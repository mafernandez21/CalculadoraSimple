...
public class VistaCalculadora extends JFrame {
    ...
    private HashMap metaDatos = new HashMap();
    private ActionListener controlador;
    private boolean operacionLista;
    private boolean nuevoCalculo;

    /**
     * La vista crea una nueva ventana y todos los metodos para su manejo. 
     */
    public VistaCalculadora(ActionListener controlador) {
        initComponents();
        this.operacionLista = false;
        this.nuevoCalculo = true;
        this.controlador = controlador;
        this.jButton15.setActionCommand("CALCULAR");
        this.jButton15.addActionListener(this.controlador);
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (this.nuevoCalculo) {
            this.nuevoCalculo = false;
            this.jTextField1.setText("");
        }
        this.jTextField1.setText(this.jTextField1.getText() + "2");
        if (!this.operacionLista) {
            this.metaDatos.put("N1", this.jTextField1.getText());
        } else {
            this.metaDatos.put("N2", this.jTextField1.getText());
        }
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        this.jTextField1.setText("");
        this.metaDatos.put("OPERACION", "Suma");
        this.operacionLista = true;
    }//GEN-LAST:event_jButton11ActionPerformed

    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        this.jTextField1.setText("");
        this.metaDatos.put("OPERACION", "Diferencia");
        this.operacionLista = true;
    }//GEN-LAST:event_jButton12ActionPerformed

    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        this.jTextField1.setText("");
        this.metaDatos.put("OPERACION", "Producto");
        this.operacionLista = true;
    }//GEN-LAST:event_jButton13ActionPerformed

    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        this.jTextField1.setText("");
        this.metaDatos.put("OPERACION", "Cociente");
        this.operacionLista = true;
